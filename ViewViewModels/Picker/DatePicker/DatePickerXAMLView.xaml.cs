...
public partial class DatePickerXAMLView : ContentPage
{
    ...
    {
        /***********************************************
         * We will set the Date, Min Date, and Max Date here
         ***********************************************/
    ...
    private async void Button_Clicked(object sender, EventArgs e)
    {
        ...
        else
        {
            msg = "The dates were changed! \n\n" +
                      ...
                      "New start date selected is: " + _startDateSelected.ToShortDateString() + "\n " +
                      "New end date selected is: " + _endDateSelected.ToShortDateString();
        }
